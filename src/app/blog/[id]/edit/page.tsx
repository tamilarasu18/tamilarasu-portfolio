...
export default function EditBlogPage({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      // Pass the original slug to update the existing file
      const response = await fetch("/api/blog", {
        ...
        body: JSON.stringify({
          slug: id, // Vital: Pass the slug to ensure update
          title,
          content,
          coverImage,
          tags,
      ...
      <header className="fixed top-0 left-0 right-0 bg-white border-b border-gray-100 z-40">
        <div className="max-w-4xl mx-auto px-6 h-16 flex items-center justify-between">
          ...
          <div className="flex items-center gap-3">
            <span className="text-sm text-[#6b6b6b]">Editing</span>
            <button
            ...
            <form onSubmit={handleSubmit}>
              <div className="p-6 border-b border-gray-100">
                ...
                <p className="text-[#6b6b6b] text-sm">
                  Review tags and authenticate to update your story.
                </p>
              </div>
