...
import { fetchBlogs, type BlogPostMeta } from "@/lib/blog";
...
function generateBlogListJsonLd(blogs: BlogPostMeta[]) {
  return {
    "@context": "https://schema.org",
    "@type": "CollectionPage",
    name: "Blog | Tamilarasu",
    description:
      "Read articles about web development, Flutter, React, Next.js, AI, and more by Tamilarasu.",
    url: `${BASE_URL}/blog`,
    mainEntity: {
      "@type": "ItemList",
...
export default async function BlogPage() {
  ...
  const jsonLd = generateBlogListJsonLd(blogs);
        ...
        <div className="pt-24 pb-20 px-6">
          <div className="max-w-6xl mx-auto">
            {blogs.length === 0 ? (
              ...
              <BlogListWithSearch blogs={blogs} />
            )}
          </div>
        </div>
      </main>
